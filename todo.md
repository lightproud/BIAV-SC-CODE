...
- [ ] 删冗余 Release `art-assets-v1`（2026-06-21 核实仍在线，未删）。已备 `Delete Release` workflow
  （`.github/workflows/delete-release.yml`），守密人 Actions 页面点 Run 即删，免手机手动；删后移除 RELEASES.md 该行。
