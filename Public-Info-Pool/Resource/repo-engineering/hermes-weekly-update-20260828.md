...
**本档定稿时为「进行中」**：run [#27](https://github.com/lightproud/BIAV-SC-CODE/actions/runs/33106017338)（构建自 `de7e8acc`）已触发，结论待回查后回填本节。**在回查确认资产真被覆盖之前，第三节的下载链接仍指向上一版（v2026.8.19 那一版，2026-08-27 06:43 北京）。**
