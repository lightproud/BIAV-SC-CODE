...
> **⚠ 定格交付物（2026-06-03 快照）**：文中文件/脚本路径反映当时仓库状态；其中自造记忆子系统（dream / memory_search / knowledge_graph 等）、fetch_* 抓取链、wiki generate_pages 等已于 2026-06 退役删除，相关引用按历史快照理解，不指向现行文件。
>
