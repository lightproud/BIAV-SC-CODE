...
description: "Defines the built-in Concise output style to lead with results, omit narration, stay brief by default, and preserve requested detail and correctness"
ccVersion: "2.1.237"
-->
