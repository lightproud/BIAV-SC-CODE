...
description: "Describes the Workflow tool's background execution, explicit opt-in requirements, pure-literal metadata requirement, and canonical pipeline-based review pattern"
ccVersion: "2.1.248"
variables:
  - "AGENT_TOOL_NAME"
-->
