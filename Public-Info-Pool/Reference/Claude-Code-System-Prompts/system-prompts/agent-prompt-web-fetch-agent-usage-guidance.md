...
description: "Explains when and how to delegate URL reading to the built-in web-fetch agent, including binary-file trust boundaries and follow-up messaging"
ccVersion: "2.1.251"
variables:
  - "WEBFETCH_TOOL_NAME"
