...
description: "Announces that plugin eval is enabled in the current session and explains how clients that cannot receive the organization rollout can set the enablement variable without relying on project settings"
ccVersion: "2.1.233"
-->
