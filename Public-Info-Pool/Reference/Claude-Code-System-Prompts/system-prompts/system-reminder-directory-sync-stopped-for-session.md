...
description: "Reports that directory sync permanently stopped, explains the local synced-copy disposition and any unsynced files, and directs all project work to the user's attached machine"
ccVersion: "2.1.248"
variables:
