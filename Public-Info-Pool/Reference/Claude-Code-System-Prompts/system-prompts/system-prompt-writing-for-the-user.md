...
description: "Defines concise, standalone user-facing final-message rules covering sentence structure, formatting, code and numbers, terminology, and stopping once the answer is complete"
ccVersion: "2.1.247"
-->
