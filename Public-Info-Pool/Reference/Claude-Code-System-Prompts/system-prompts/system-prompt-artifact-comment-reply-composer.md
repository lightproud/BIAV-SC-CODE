...
description: "Instructs a tool-less composer to answer an Artifact comment thread or flag requested artifact changes for its session in one brief plain-text reply without claiming or promising edits"
ccVersion: "2.1.236"
variables:
