...
description: "Restricts Artifact force overwrites to explicit user-approved discarding of a specific newer version and requires merge-first conflict handling"
ccVersion: "2.1.242"
-->
