...
description: "Describes the Poll tool for waiting on queued harness events, signaling idleness, and interpreting event provenance, nonce manifests, and chunked delivery"
ccVersion: "2.1.237"
-->
