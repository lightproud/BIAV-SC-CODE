...
description: "Reports that directory sync is disabled after the initial checkout failed, states that the cloud working directory lacks the user's files, and directs project work to the attached machine"
ccVersion: "2.1.248"
variables:
  - "SYNC_DISABLE_REASON"
