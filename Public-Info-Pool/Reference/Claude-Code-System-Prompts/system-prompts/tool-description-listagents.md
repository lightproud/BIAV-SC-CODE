...
description: "Describes the ListAgents tool, which lists agents you can message — in-process subagents, teammates, other local and cloud Claude sessions, and remote bridge sessions"
ccVersion: "2.1.239"
variables:
