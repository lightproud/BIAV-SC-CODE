...
| 采集版本 | Claude Code v2.1.261 |
| 上游 commit | `0870e1e12c05954604cf5e22aaa34a5b338bcdec` |
| 上游 commit 日期 | 2026-09-04 |
| 许可证 | MIT（Copyright (c) 2025 Piebald LLC）——见同目录 `LICENSE`，再分发须随附 |

## 内容清单

- `system-prompts/`：**694** 份 markdown，每份含 YAML frontmatter（标注 Claude Code 版本 + 模板变量）。
