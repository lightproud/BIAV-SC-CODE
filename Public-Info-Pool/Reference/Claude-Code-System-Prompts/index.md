...
| 采集版本 | Claude Code v2.1.220 |
| 上游 commit | `2393c77403f14957d35d3c039383abb54c61c092` |
| 上游 commit 日期 | 2026-07-24 |
| 许可证 | MIT（Copyright (c) 2025 Piebald LLC）——见同目录 `LICENSE`，再分发须随附 |

## 内容清单

- `system-prompts/`：**610** 份 markdown，每份含 YAML frontmatter（标注 Claude Code 版本 + 模板变量）。
