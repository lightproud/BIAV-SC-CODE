...
│   └── silver-core-hermes/ # 使命#2 现行核心载体（2026-08-02 换轨裁定）：Hermes Agent（NousResearch/hermes-agent，MIT）改造扩展层——上游跟随 + 扩展层不硬 fork，银芯→黑池单向输出，见 project-status「## Silver Core Hermes」
