...
**浅色重设计待裁（2026-08-05，方案已出）**：守密人反馈「黑池金浅色模式不太好」。查证结论——**这不是新问题**：`memory/style-guide.md` v3.0（2026-07-12 守密人两轮反馈后裁定）已记「初版底/卡/墨全在黄调里，与金只剩明度差、没有色相差，守密人反馈『整体偏黄、金不凸显』」，并把初版底色 `#f7f3ea` **判为偏黄已弃**。而 Desktop 浅色底 `#F5F2E9` 与之色相同为 44°、肉眼无从分辨——**Desktop 主题从未跟上那次裁定**。三方案均出自该裁定谱系：甲「纸白中性」= v3.0 乳白金定稿逐色对齐（推荐，已过两轮反馈）· 乙「瓷白」/ 丙「高白高对比」= 当时同批对照中落选的两版，在长时间注视的 Desktop 场景下重新有用武之地。共用一条纪律：**金以外的一切去黄提灰，金是画面唯一高饱和暖色**。`darkColors` 一字不动。
