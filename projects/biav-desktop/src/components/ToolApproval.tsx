  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="rounded-lg border border-biav-border bg-biav-bg/50 p-3">
          {/* Header */}
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xs font-medium text-amber-400">工具调用</span>
            <span className="text-xs text-biav-muted">
          ...
          {/* Arguments */}
          <div className="mb-3">
            <pre className="text-xs bg-biav-border/30 rounded p-2 overflow-x-auto max-h-40 overflow-y-auto text-biav-text/80">
          ...
          {isPending && (
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-1 text-xs rounded bg-biav-border hover:bg-biav-border/80 text-biav-text/70 transition-colors"
              >
                始终允许
              </button>
            </div>
          ...
          {/* Executing spinner */}
          {isExecuting && (
            <div className="flex items-center gap-2 text-xs text-biav-muted">
