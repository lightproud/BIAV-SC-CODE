...
export default function StreamingStatus({ tokens, duration }: StreamingStatusProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-1">
      <div className="flex items-center gap-2 text-xs text-biav-muted bg-biav-bg-secondary/50 rounded px-3 py-1.5">
        <span className="inline-block w-2 h-2 rounded-full bg-biav-gold animate-pulse" />
        <span>
