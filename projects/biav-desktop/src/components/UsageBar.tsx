...
export default function UsageBar({ usage }: UsageBarProps) {
  return (
    <div className="flex items-center gap-1.5 text-[11px] text-biav-muted mt-1 ml-10 select-none">
...
export function SessionUsageBar({ totalInput, totalOutput, totalCost }: SessionUsageBarProps) {
  ...
  return (
    <div className="text-[11px] text-biav-muted px-3 py-1.5 select-none truncate">
