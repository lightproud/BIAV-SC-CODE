...
**当前版本 `2.0.7`** · 发布日 2026-07-29 · 家族锁步对端 `silver-core-agent-sdk` = `2.0.7`

> 本行由 `scripts/build_status_facts.py` 从 `package.json` + `CHANGELOG.md` 生成，**勿手改**；规模数字不在此列，指 `memory/project-status.md` 的 STATUS-FACTS 块。下方叙述由人写（「这一版做了什么」是判断、生成不出来），其**新鲜度**由`tests/test_status_doc_facts.py` 守。

<!-- CONTEXT-FACTS:END -->

**v2.0.7（2026-07-29）：锁步对齐**——无本包运行时改动；agent SDK 1.8.3 为审计第二十四波，家族版本钟锁步（守密人 2026-07-18 裁定）故同步升位。

**v2.0.6（2026-07-29）：锁步对齐**——无本包运行时改动；agent SDK 1.8.2 为审计第二十三波，家族版本钟锁步（守密人 2026-07-18 裁定）故同步升位。

**v2.0.5（2026-07-29）：锁步对齐**——无本包运行时改动；agent SDK 1.8.1 为审计第二十二波，家族版本钟锁步（守密人 2026-07-18 裁定）故同步升位。

**v2.0.4（2026-07-29）：锁步对齐**——无本包运行时改动；agent SDK 1.8.0 新开后台任务第二投递通道，家族版本钟锁步（守密人 2026-07-18 裁定）故同步升位。

**v2.0.3（2026-07-29）：锁步对齐**——无本包运行时改动；agent SDK 1.7.0 关掉两项守密人裁定，家族版本钟锁步（守密人 2026-07-18 裁定）故同步升位。

**v2.0.2（2026-07-29）：锁步对齐**——无本包运行时改动；agent SDK 1.6.0 为审计第二十一波，家族版本钟锁步（守密人 2026-07-18 裁定）故同步升位。

**v2.0.1（2026-07-29）：锁步对齐**——无本包运行时改动；agent SDK 1.5.0 为审计第十九、二十波，家族版本钟锁步（守密人 2026-07-18 裁定）故同步升位。
...
**v2.0.2（2026-07-29）：锁步对齐**——本包零代码改动，随 agent SDK 1.6.0（T75 二次拷问：dream 信号源 + 巡回只读预设）前进。
