...
function writeTrace(arm, task, repeatIdx, run) {
  ...
  const payload = {
    generated_for: 'silver-core-sdk conformance L6 (official-arm public-stream trace retention)',
...
const report = {
  generated_for:
    'silver-core-sdk conformance L5 (five-dimension task library, gate B) + L6 trace retention',
