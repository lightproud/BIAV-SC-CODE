...
export const KNOWN_DIVERGENCES = [
  ...
  { id: 'KD-13', official: 'system/commands_changed', note: 'official-only slash-command registry announcement: engine 2.1.215 emits system/commands_changed once early in EVERY headless run (right after active_goal, before system/init) - new vs the 2.1.201 baseline, the single root cause of the 2026-07-29 re-ratification sweep (L1 3/3, L2 13, L4 9 scenarios all realigned once consumed). Typed-not-emitted here for the KD-01/KD-08 reason: slash-command parsing exited engine behavior by keeper ruling 2026-07-17, so a headless run has no source event for it (observed stable across 2 full differential runs, 2026-07-29, agent-sdk 0.3.215 + claude-code 2.1.215)' },
];
