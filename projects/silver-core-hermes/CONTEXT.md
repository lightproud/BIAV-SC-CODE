...
1. **上游跟随 + 扩展层**（守密人 2026-08-02 裁定，否决硬 fork 魔改）：尽量不改上游核心，
   扩展优先走上游原生机制（skills / tools / transports / gateway 插件位），定期合并上游。
   上游迭代极快（v0.13.0 单版 864 commits / 295 贡献者），硬 fork 会迅速脱轨。
