 ...
 * EnterWorktree) + batch 3 (Monitor). Still English: Bash (+ git protocol +
 * sandbox fragments), Workflow — later batches. Translated tools are
...
export const TOOL_DESCRIPTION_PROVENANCE: ToolDescriptionProvenance[] = [
  ...
  // All removed from the English corpus-sync guard; covered by
  // tests/tool-descriptions-i18n-zh.test.ts. Bash + Workflow stay English
  // (later batches).
