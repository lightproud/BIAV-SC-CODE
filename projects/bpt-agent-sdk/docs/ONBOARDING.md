# Onboarding — bpt-agent-sdk in 30 minutes
...
`bpt-agent-sdk` is an independent TypeScript agent harness whose **public API is
...
- What's currently open / recently shipped: `CHANGELOG.md` top +
  `../../memory/project-status.md` "## BPT Agent SDK".
