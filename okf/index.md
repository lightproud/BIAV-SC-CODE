...
* [记忆 memory](/memory/index.md) - 45 concept · 记忆层全层指针
* [剧情 story](/story/index.md) - 11 concept · 剧情结构层指针
* [事实圣经 assets](/assets/index.md) - 12 concept · 角色卡/采访/叙事/设计决策指针
* [wiki 数据 wiki-data](/wiki-data/index.md) - 18 concept · 解包自举结构化数据集指针
...
* [产物 resource](/resource/index.md) - 34 concept · 银芯正式报告/分析指针
* [子项目 projects](/projects/index.md) - 9 concept · CONTEXT/藏宝图/工程文档指针
