...
* [archive-integrity](/assets/assets-archive-integrity.md) - archive-integrity 事实数据
* [card-system](/assets/assets-card-system.md) - card-system 事实数据
* [design-decisions](/assets/assets-design-decisions.md) - design-decisions 事实数据
* [interview-2026-04](/assets/assets-interview-2026-04.md) - interview-2026-04 事实数据（total_questions=53）
* [narrative-structure](/assets/assets-narrative-structure.md) - 忘却前夜叙事结构数据库 — 事实圣经核心文件
