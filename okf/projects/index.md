...
* [silver-core-hermes 子项目上下文](/projects/project-silver-core-hermes.md) - 1. **核心零侵入**：一切能力走官方扩展面（plugins entry points / `skills.external_dirs` /
...
* [silver-core-sdk COMPAT](/projects/silver-core-sdk-doc-compat.md) - **What this document is.** A reference record of how the official
...
* [silver-core-sdk MIGRATION-0.3x-to-0.68](/projects/silver-core-sdk-doc-migration-0-3x-to-0-68.md) - Audience: a consumer (BPT Desktop) pinned on the **0.3x tarball line**
...
* [silver-core-sdk POSITIONING](/projects/silver-core-sdk-doc-positioning.md) - Silver Core SDK(BIAV-SC 引擎)是黑池五层介质架构中的**引擎层**:最慢的介质、
...
* [site design · morimens-design-system-guide.html](/projects/site-design-morimens-design-system-guide.md) - site 设计系统权威（morimens-design-system-guide.html，22.7KB）：设计令牌 / 组件规范来源。
* [site design · morimens-design-tokens.css](/projects/site-design-morimens-design-tokens.md) - site 设计系统权威（morimens-design-tokens.css，7.2KB）：设计令牌 / 组件规范来源。
