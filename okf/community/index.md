...
* [weixin 社区全量档案](/community/community-weixin.md) - weixin 平台全量档案层（分析镜头）：千级条（精确值见指针本体）/ 10 个月。长窗口分析 / 情感长尾 / 完整性审计走此全量层。
...
* [社区活动时序（全量）](/community/community-timeline.md) - 全量社区月度时序：2018-07..2026-07（37 月），vol_index 抓量异常（本月量÷前6月中位数）。
