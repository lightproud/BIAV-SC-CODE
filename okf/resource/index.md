...
* [bpt-sdk-comparison-baseline-20260705](/resource/resource-data-diagnostics-bpt-sdk-comparison-baseline-20260705.md) - v4 忠实再现的官方提示词在硬任务上**无可测收益 → 不提为默认**；vs-official 显示本 SDK **快 ~2.7×、省 ~8%、正确性不劣（本轮
