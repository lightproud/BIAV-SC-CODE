...
| 事实 | 值 | 权威源 |
|------|----|--------|
| Silver Core Agent SDK 版本 | `2.0.0` | `projects/silver-core-sdk/package.json` |
| Silver Core Maestro SDK 版本 | `2.0.0` | `projects/silver-core-maestro-sdk/package.json`（与 agent 锁步同号）|
