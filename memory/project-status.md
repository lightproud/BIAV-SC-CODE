...
| 事实 | 值 | 权威源 |
|------|----|--------|
| Silver Core Agent SDK 版本 | `1.8.1` | `projects/silver-core-sdk/package.json` |
| Silver Core Maestro SDK 版本 | `1.8.1` | `projects/silver-core-maestro-sdk/package.json`（与 agent 锁步同号）|
| testbed 试金石 | `0.0.0`（private，永不发布）| `projects/silver-core-testbed/package.json` |
| agent SDK 源文件 / 测试档 | 140 / 224 | 磁盘实况 |
