...
| 2026-04-29 | BPT-Master 立项（`projects/bpt-master/`，Claude 桌面应用本地仿制体：Electron 33 + Vite 5 + React 18 + TS，API key 仅入 OS safeStorage，Design 模块对标 Claude Design，9 阶段路线图，阶段 1 对标率 ≥85% 可归档） | 阶段 1 内部对标率 88%；整体 1:1 需多阶段 + 服务端能力，本地不可达 | bpt-master（2026-08-02 载体换轨后退役；本条由本地未提交残留捞回，2026-08-09 晓光/Hermes） |
