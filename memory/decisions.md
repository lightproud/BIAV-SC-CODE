...
> 最后更新：2026-07-05 by BPT Agent SDK 会话（G8：新增 2 条 BPT 裁定——定位反转 clean-room→公开信息再现、提示词装配层 Track B + v5 默认，守密人授权代写）
>
