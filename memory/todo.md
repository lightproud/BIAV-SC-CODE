...
| T12 | 命令行为观测续册：A 类 P0 组余 /clear /resume /help（须守密人会话内触发，艾瑞卡不可自触）。已清两笔：**/loop 动态自调步**（2026-07-11 艾瑞卡自触完整生命周期，OBS-011）；**/compact**（2026-07-11 守密人触发，同会话拿到手动 + 自动双路径对照——「压缩机器一套、触发口两个」+ 压缩后窗口五段结构 + compact_boundary 不进上下文，OBS-012；带聚焦 args 变体降级 P2）| 预算 | `.../cc-command-behavior-observations-20260710.md` 待观测清单 + OBS-011/012 | 开（余 /clear /resume /help 待守密人触发） |
