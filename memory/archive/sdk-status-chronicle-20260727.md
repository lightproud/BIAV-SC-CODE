...
## 追加下沉（2026-07-29，v1.5.0 入档时）

> 按本节norm「只留定位 + 最近版叙述，新版本进来时把上一版下沉归档」，以下两条逐版叙述自 `memory/project-status.md` 原文迁入，一字未改。逐版权威仍是 `projects/silver-core-sdk/CHANGELOG.md`。
...
<!-- maestro 侧条目下沉（2026-07-29 合并 main 后行数超限） -->
