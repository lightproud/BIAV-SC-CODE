...
**一句话摘要**：银芯（公开信息层）与黑池（内部层 SVN + Qoder）通过**严格单向流动**协作——银芯采集外部信息单向输出至黑池，黑池任何形式（代码 / 数据 / 设计 / 反馈）都不允许写入银芯仓库。BPT 指导由守密人通过「人工对话搬运」协议执行（原 Code-BPT + 主控台双指导角色 2026-06 退役）。
...
| 系统 | 层级 | 存储 | 内容性质 | 访问范围 |
|---|---|---|---|---|
| **银芯（BIAV-SC）**| 公开信息层 | GitHub（lightproud/brain-in-a-vat）| 外部信息 + 方法论验证 + 社区共建底座 | 整层公开（守密人 2026-06-21 裁定，覆盖 2026-06-11 受限/非公开层定位）|
...
| v1.1 | 2026-06-28 | 定位同步：层级「受限层」→「公开信息层」、访问范围对齐 2026-06-21 翻回公开裁定（覆盖 2026-06-11）；防火墙单向硬约束不动 | 艾瑞卡 |
