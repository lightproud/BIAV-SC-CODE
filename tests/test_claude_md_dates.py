...
# 形态：{ "YYYY-MM-DD": "豁免理由" }
ALLOWLIST = {
    # 当前为空。哨兵 2026-06-21 首跑抓出的 2026-06-15 跨档漂移（wiki 结构化层清空裁定从未进
    # 决策台账），已经守密人 2026-06-21 授权补录进 decisions.md，漂移消除、本豁免随之移除。
    # 空 allowlist 是目标：真实漂移应当 fail，由守密人决定「补台账」还是「加豁免」，而非默认吞掉。
}
